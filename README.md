...
This project is a web application for sharing recipes and also you can make recipes from AI with ingredients you have. You can also search for recipes from other websites. Now you can find <a href="https://your-recipe-61b00c24cb63.herokuapp.com/">here</a> it is deployed on Heroku server. <br>
